...
escritorio psutil.sensors_battery() devuelve None. Ese caso no es un error
del programa, es un sensor ausente, y el sistema debe seguir funcionando
sin el.

El campo power_plugged es una senal digital: conectado o desconectado. Su
cambio es el evento de flanco mas facil de provocar en el laboratorio:
